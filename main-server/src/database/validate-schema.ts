...
const REQUIRED_INDEXES = [
  ...
  'idx_prediction_results_run',
  'idx_prediction_result_metrics_result',
  'uq_prediction_results_running_per_run',
  'idx_generated_reports_run',
  'idx_process_setup_revisions_current_approved',
  'idx_process_setup_revision_parameters_revision',
  'idx_production_run_process_values_run',
