...
export class ProcessSetupController {
  ...
  initializeRunValues(req: Request, res: Response): void { respondJson(res, () => this.service.initializeRunValues(req.params['id'] ?? '', this.actor(req)), { errorStatus: this.status }); }
