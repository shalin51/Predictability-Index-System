...
const extraLibraryConfigs: Record<string, LibraryEntityConfig> = {
  ...
  'scoring-rules': {
    ...
    mutableColumns: ['benchmarkProfileId', 'metricId', 'metricName', 'metricCategory', 'unit', 'targetMean', 'minAcceptable', 'maxAcceptable', 'targetStdDev', 'comparisonMode', 'weight', 'criticality', 'requiredForPass'],
