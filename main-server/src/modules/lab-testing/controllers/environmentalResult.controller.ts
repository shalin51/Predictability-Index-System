...
import type { EnvironmentalResultService } from '../services/environmentalResult.service';

export class EnvironmentalResultController {
  constructor(private readonly service: EnvironmentalResultService) {}
