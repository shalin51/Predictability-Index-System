/** Domain values used by database-backed workflows and Excel import templates. */
...
export const PRODUCTION_RUN_STATUSES = ['planned', 'molded', 'curing', 'ready_for_testing', 'testing', 'scored', 'archived'] as const;
